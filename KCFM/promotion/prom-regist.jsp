<%
/** ############################################################### */
/** Program ID   : prom-regist.jsp                         */
/** Program Name :  prom-registl	       					*/
...
<%
	...
	System.out.println(">>>> prom-regist >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
...
<head>
	...
	function chgGroup(val){
		...
		$.ajax(
				{
					url      : "<%=root%>/promotion/prom-regist-combo.jsp",
					type     : "POST",
	 ...
	 function goRegist()
	{
		...
		frm.action = "<%=root%>/promotion/prom-regist-ok.jsp?mode1=" + vModYn1 + "&mode2=" + vModYn2 + "&mode3="+ vModYn3;
 	...
 	<div id="wrap" >
	 	...
	 	<section id="info-panel">
 		  ...
 		  <section class="contents admin" style="top: 25px">
 		 	<header>
 		 		<h1>◎ <span>홍보물 관리 &gt; 신규 등록/수정</span></h1>
 		 	</header>
 		 	
 		 	<div id="cont-admin" style="top: 25px">
