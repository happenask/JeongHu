...
<% 
	...
	String pCompanyCd = JSPUtil.chkNull((String)request.getParameter("inCompanyCd"), "");
	...
	if("corp".equals(gubun)){
		...
		if( list != null && list.size() > 0 ) 
		{
			...
			for( int i = 0; i < list.size(); i++ ) 
			{
				...
				companyCd = JSPUtil.chkNull(bean.get법인코드());
				companyNm = JSPUtil.chkNull(bean.get법인명());
				
			    msg += "<option value='"+companyCd+"'>"+companyNm+"</option>";
			}
		}else{
