/** ############################################################### */
/** Program ID   : LoggableStatement.java                           */
/** Program Name :                                                  */
/** Program Desc :                                                  */
/** Create Date  :                                                  */
/** Programmer   :                                                  */
...
public class LoggableStatement implements PreparedStatement 
{
	...
	{
		this.wrappedStatement = connection.prepareStatement(converCharset(sql));
	...
	public LoggableStatement(Connection connection, String sql, Object obj)	throws SQLException 
	{
		...
		{
			   classname.append(obj.getClass().toString());
			   classname.append("\n\n /* "+classname +" */ \n");
		}
		
		classname.append(sql);
		this.wrappedStatement = connection.prepareStatement(classname.toString());
		this.sqlTemplate      = classname.toString();
		this.parameterValues  = new ArrayList();
	}
...
//		}
	...
	/********************************************************************************
	 *
	 * 占쎈Ŧ猷욅빊遺쏙옙 筌롫뗄苑뚳옙占� 筌롫뗄苑뚳옙占쏙옙類ㅼ벥 占쎄쑴�귨옙占�
	 *
	 ********************************************************************************/	
