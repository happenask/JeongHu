...
//    		alert("attachFileName [ "+attachFileName+" ]");
    ...
    //분류 옵션 자동 설정하기
    function gbSelect(index){ 
    	document.form1.mSelect.selectedIndex = index;
    	//console.log(index);
    } 
    
	function goList(root)
	{	
		location.href= "request-list.jsp";
	}
    </script>
</head>
				    		...
				    		<tbody>
				    			<tr>
				        			...
				        			<td>유니타스 1호점</td>
				      				<th>분류</th>
				        			<td>
				        				<select name="mSelect"><option>선택</option><option>물류클레임</option><option>포스게시판</option><option>인테리어 보수/신청</option></select>
				        			</td>
				      			</tr>
				    			<tr>
				      				<th>제목</th>
				    			...
				    			<tr>
				      			...
				      			<tr>
				      				<th>첨부</th>
				        			<td colspan="3"><input type="file" id="attachFile" class="fileBtn" name="attachFile" onchange="fnChangeAttachFile(this);"/>&nbsp;</td>
			        			</tr>
				    		</tbody>
				  		</table>
				 		<p class="btn">
