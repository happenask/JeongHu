<%
/** ############################################################### */
/** Program ID   : maintain-comment-edit-ok.jsp                     */
/** Program Name : 댓글관리 > 상세화면 > 수정                                                       */
/** Program Desc :                                                  */
...
//	String s댓글내용      = JSPUtil.chkNull((String)request.getParameter("pDAGL_STMT"),  "");
	...
	if(dataGb.equals("modify")){	
		...
		if(pageGb.equals("11")||(pageGb.equals("12"))){	
			rtn = dao.commentRollback(paramData);
			System.out.println(pageGb);
		}
