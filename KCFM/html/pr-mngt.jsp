<!-- 
/** ############################################################### */
/** Program ID   :   promotion pr-mngt.jsp     						*/
/** Program Name :   promotion 관리	   						        */
/** Program Desc :   홍보물 관리        							*/
...
<%
	...
	//####################################################################################################java 처리 시작
	mainBean mainBean  = null; //리스트 데이타에서 담을 빈
	mainBean nBean     = new mainBean(); //내용보기 에서 담을 빈
	...
	list = mainDao.selectStoreOrderList(paramData); //홍보물관리
 	...
 	<div id="wrap" >
		...
		<form id="form1" name="form1" method="post">
			...
			<section class="contents admin">
				<header><h1> ◎ <span>promotion service &gt; 홍보물관리</span></h1></header>
			
				<div id="cont-list" class="list list-wide">
					<p>▶ 홍보물관리 <span>0</span>개</p>
...
%>
			  		...
			  		<div id="search-option">
			    		...
			    		<select id="search_type" name="search_type" style="height:20px; width:80px;">
			    			...
			    			<option value="title">매장</option>
			    			<option value="content">주문자</option>
			    		</select>			    		 		
