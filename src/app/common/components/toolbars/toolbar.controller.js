(function() {
    ...
    /* @ngInject */
    function DefaultToolbarController($scope, $rootScope, $mdMedia, $translate, $state, $element, $filter, $mdUtil, $mdSidenav, $mdToast, $timeout, $document, triBreadcrumbsService, commonSettings, commonLayout) {
        var vm = this;
        ...
        function hideMenuButton() {
            return commonLayout.layout.sideMenuSize !== 'hidden' && $mdMedia('gt-sm');
        }
