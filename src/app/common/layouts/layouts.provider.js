(function() {
    ...
    function layoutProvider() {
        ...
        layoutDefaults.isMobile = mobileAndTabletcheck();

        layoutDefaults.mobileDevice = (function (a) {
        ...
        // vm.launchApp = function () {
        //     window.location = "youtube://";
        //     $timeout(function () {
        //         window.location = "https://itunes.apple.com/kr/app/youtube/id544007664?mt=8#";
        //     }, 1000);
        // };
        ...
        this.$get = function() {
            ...
            function updateLayoutFromType(type) {
                layoutDefaults.containerClass = "";
                layoutDefaults.leftSideClass = "";
                layoutDefaults.contentSideClass= "";
                if(type === 'myPage') {
                    layoutDefaults.containerClass = "content profile";
                    layoutDefaults.leftSideClass = "col-md-3 md-margin-bottom-40";
                    layoutDefaults.contentSideClass= "col-md-9";
                    angular.extend(layout, layoutDefaults);
                }
                else if(type == 'popup') {
                    layoutDefaults.headMenu = false;
                    layoutDefaults.footer = false;
                    layoutDefaults.containerClass = "popup-content";
                    angular.extend(layout, layoutDefaults);
                }
                else if(type === 'try/detail') {
                    layoutDefaults.footer = false;
                    angular.extend(layout, layoutDefaults);
                }
                else {
                    layoutDefaults.footer = true;
                    angular.extend(layout, layoutDefaults);
                }
            }
            ...
            return {
                ...
                updateLayoutFromType: updateLayoutFromType
            };
        };
    }

    /* @ngInject */
    function layoutRunner($rootScope, commonLayout) {
        ...
        var destroyOn = $rootScope.$on('$stateChangeStart', commonLayout.updateLayoutFromState);
