...
public class AddressTO {
	...
	public AddressTO(String zipcode, String sido, String gugun, String dong,
			String bunji, String seq) {
		super();
	...
	public String toString() {
		return "AddressTO [zipcode=" + zipcode + ", sido=" + sido + ", gugun="
				+ gugun + ", dong=" + dong + ", bunji=" + bunji + ", seq="
				+ seq + "]";
	}
