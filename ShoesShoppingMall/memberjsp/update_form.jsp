...
$(document).ready(function(){
  ...
  <font color="#353535"><h2><i><u>회원정보 수정</u></i></h2></font>
	<font color="#8C8C8C"><h3>기본정보</h3></font>
	

	<form method ="POST" action="/kostaWebS/updateMember.do" name="joinForm">
	<table border="0" bordercolorlight="#D5D5D5" bordercolordark="white" cellspacing="0" width="800" height="500" class="topline">
		...
		<tbody>
			...
			<tr>
				...
				<td class="line"><input type="text" name="id" id = "id" value="${sessionScope.login_info.id}"/><img alt="아이디중복확인" src="/kostaWebS/images/decoration/checkId.jpg" id="idCheck"> (영문소문자/숫자, 4~16자)</td>
			</tr>
			<tr>
				<th class="line">별명</th>
			...
			<tr>
				<th class="line">이름</th>
				<td class="line"><input type="text" name="name" id ="name" value="${sessionScope.login_info.name}"/></td>
			</tr>
			<tr>
				<th class="line">주민등록번호</th>
				<td class="line"><input type="text" name="registerNumber1" maxlength="6" id = "reg1" value="${sessionScope.login_info.registerNumber1}"/>-<input type="text" name="registerNumber2" maxlength="7" id="reg2" value="${sessionScope.login_info.registerNumber2}"/>
			...
			<tr>
				...
				<input type="hidden" name = "memberLevel" value="A"/>
				</td>
			</tr>
			<tr>
		...
		<tfoot>
				<tr>
					<td colspan="3">
						<a href = "/kostaWebS/memberDrop.do"><img alt="회원탈퇴" src="/kostaWebS/images/decoration/memberDrop.jpg" border="0" id="memberDropBtn"/></a>
							<span style="padding-left:250px;text-decoration:none ">
						<a href = "/kostaWebS/mainPage.do"><img alt="취소" src="/kostaWebS/images/decoration/modify_cancel.jpg" border="0" id="cancelBtn"/></a>
							<input type="image" src ="/kostaWebS/images/decoration/modify.jpg" border="0" id="modifyBtn"/>
							</span>
